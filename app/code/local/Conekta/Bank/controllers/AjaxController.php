...
class Conekta_Bank_AjaxController extends Ajax_Controller {

    public function indexAction() {
		$key=Mage::getStoreConfig('payment/bank/apiprivatekey');
		$quote = Mage::getSingleton('checkout/cart')->getQuote();
		$currency=Mage::getStoreConfig('payment/bank/currency');
