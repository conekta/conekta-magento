...
ALTER TABLE `{$installer->getTable('sales/quote_payment')}` ADD `bank` VARCHAR( 25 ) NOT NULL;
...
ALTER TABLE `{$installer->getTable('sales/order_payment')}` ADD `bank` VARCHAR( 25 ) NOT NULL ;
