<?php
class Conekta_Invoice_Model_Checkout_Type_Onepage extends Mage_Checkout_Model_Type_Onepage{
	...
	public function saveInvoice($data){
		...
		$this->getCheckout()
		->setStepData('invoice', 'allow', true)
		->setStepData('invoice', 'complete', true);
