<?php
class Conekta_Ficha_Model_Checkout_Type_Onepage extends Mage_Checkout_Model_Type_Onepage{
	...
	public function saveFicha($data){
		if (empty($data)) {
		...
		$this->getCheckout()
		->setStepData('ficha', 'allow', true)
		->setStepData('ficha', 'complete', true);
